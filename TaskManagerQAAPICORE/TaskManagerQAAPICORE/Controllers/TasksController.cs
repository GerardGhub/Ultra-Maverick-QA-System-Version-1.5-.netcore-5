...
namespace TaskManagerQAAPICORE.Controllers
{
  public class TasksController : Controller
  {
    ...
    public IActionResult UpdateTaskStatus([FromBody] TaskStatusDetail taskStatusDetail)
    {
      ...
      TaskModel existingTask = db.Tasks.Where(temp => temp.TaskID == taskStatusDetail.TaskID).FirstOrDefault();
    ...
    public IActionResult Post([FromBody] TaskModel task)
    {
      ...
      TaskModel existingTask = db.Tasks.Where(temp => temp.TaskID == task.TaskID).FirstOrDefault();
