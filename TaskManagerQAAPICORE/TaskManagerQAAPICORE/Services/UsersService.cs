...
namespace TaskManagerQAAPICORE.Services
{
  public class UsersService : IUsersService
  {
    ...
    public UsersService(AppSettings appSettings, ApplicationUserManager applicationUserManager, ApplicationSignInManager applicationSignInManager, ApplicationDbContext db)
    {
